...
class InProgressMoviesScreen extends StatelessWidget {
  const InProgressMoviesScreen({super.key});

  // Firestore'dan 'library' koleksiyonunu çekiyoruz
  Future<List<Map<String, dynamic>>> _fetchInProgressMovies() async {
    try {
      ...
      final querySnapshot = await FirebaseFirestore.instance
          ...
          .where('category',
              isEqualTo: "İzlemeye Devam Ettiklerim") // Kategoriyi filtrele
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.green.shade800, // Ana mavi tonu
        elevation: 5.0,
        centerTitle: false, // Başlık ortalanmış
      ),
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: _fetchInProgressMovies(),

...
class CompletedMoviesScreen extends StatelessWidget {
  const CompletedMoviesScreen({super.key});

  // Firestore'dan 'library' koleksiyonunu çekiyoruz
  Future<List<Map<String, dynamic>>> _fetchCompletedMovies() async {
    try {
      ...
      final querySnapshot = await FirebaseFirestore.instance
          ...
          .where('category', isEqualTo: "İzlediklerim") // Kategoriyi filtrele
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.blue.shade800, // Ana mavi tonu
        elevation: 5.0,
        centerTitle: false, // Başlık ortalanmış
      ),
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: _fetchCompletedMovies(),

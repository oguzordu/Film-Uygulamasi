...
class WatchlistMoviesScreen extends StatelessWidget {
  ...
  Future<List<Map<String, dynamic>>> _fetchWatchlistMoviesScreen() async {
    try {
      ...
      final querySnapshot = await FirebaseFirestore.instance
          ...
          .where('category',
              isEqualTo: "İzlemek İstediklerim") // Kategoriyi filtrele
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.yellow, // Ana mavi tonu
        elevation: 5.0,
        centerTitle: false, // Başlık ortalanmış
      ),
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: _fetchWatchlistMoviesScreen(),
